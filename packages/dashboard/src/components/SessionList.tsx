...
import { groupSessionsWithMilestones, groupIntoConversations } from '../stats.js';
import type { ConversationGroup } from '../stats.js';
import { SessionCard } from './SessionCard.js';
import { DeleteButton } from './DeleteButton.js';
import { TOOL_COLORS, TOOL_INITIALS, TOOL_ICONS, TOOL_DISPLAY_NAMES, resolveClient } from '../constants/tools.js';
  ...
  if (isSingle) {
    ...
    return (
      <SessionCard
        ...
        {...(globalShowPublic !== undefined ? { externalShowPublic: globalShowPublic } : {})}
        {...(showFullDate !== undefined ? { showFullDate } : {})}
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    ...
                    <span className="text-[15px] font-semibold truncate text-text-primary tracking-tight leading-tight">
                      <HighlightText text={showPublic ? publicConvTitle : privateConvTitle} {...(highlightWords !== undefined ? { words: highlightWords } : {})} />
                    </span>
                  </motion.div>
                </AnimatePresence>
              </div>
                ...
                {group.sessions.map((sg) => (
                  <div key={sg.session.session_id} className="relative">
                    ...
                    <SessionCard
                      ...
                      {...(showPublic ? { externalShowPublic: true } : {})}
                      hideClientAvatar
                      hideProject
                      {...(showFullDate !== undefined ? { showFullDate } : {})}
                      {...(highlightWords !== undefined ? { highlightWords } : {})}
