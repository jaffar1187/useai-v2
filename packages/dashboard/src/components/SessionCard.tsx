...
import type { SessionSeal, Milestone, SessionEvaluation } from '../lib/types.js';
import { TOOL_COLORS, TOOL_INITIALS, TOOL_ICONS, CATEGORY_COLORS, TOOL_DISPLAY_NAMES, resolveClient } from '../constants/tools.js';
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    ...
                    <span className="text-[15px] font-semibold truncate text-text-primary tracking-tight leading-tight">
                      <HighlightText text={showPublic ? publicTitle : privateTitle} {...(highlightWords !== undefined ? { words: highlightWords } : {})} />
                    </span>
                  </motion.div>
                </AnimatePresence>
              </div>
        ...
        {expanded && hasDetails && (
          ...
          >
            <div className="px-3.5 pb-3.5 pt-1.5 space-y-2">
              ...
              {!session.evaluation && <SessionMetaRow {...(session.model !== undefined ? { model: session.model } : {})} />}
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2">
                          <span className="text-xs font-medium text-text-secondary group-hover:text-text-primary truncate">
                            <HighlightText text={displayTitle} {...(highlightWords !== undefined ? { words: highlightWords } : {})} />
                          </span>
