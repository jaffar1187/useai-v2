...
import type { SessionSeal, Milestone } from '../lib/types.js';
import type { StatCardType } from './StatDetailPanel.js';
import type { Filters, ActiveTab } from '../types.js';
import type { TimeScale } from './TimeTravel/types.js';
import { ALL_SCALES, SCALE_LABELS, SCRUB_CALENDAR_MAP, isCalendarScale, getTimeWindow, jumpScale, shouldSnapToLive } from './TimeTravel/types.js';
import { computeStats, calculateStreak, filterSessionsByWindow, filterMilestonesByWindow, countSessionsOutsideWindow } from '../stats.js';
import { StatsBar } from './StatsBar.js';
import { StatDetailPanel } from './StatDetailPanel.js';
import { TimeDetailPanel } from './TimeDetailPanel.js';
import { TabBar } from './TabBar.js';
import { FilterChips } from './FilterChips.js';
import { SessionList } from './SessionList.js';
import { TimeTravelPanel } from './TimeTravel/TimeTravelPanel.js';
import { DailyRecap } from './DailyRecap.js';
import { EvaluationSummary } from './EvaluationSummary.js';
import { SkillRadar } from './SkillRadar.js';
import { ComplexityDistribution } from './ComplexityDistribution.js';
import { TaskTypeBreakdown } from './TaskTypeBreakdown.js';
import { ProjectAllocation } from './ProjectAllocation.js';
import { ActivityStrip } from './ActivityStrip.js';
import { RecentMilestones } from './RecentMilestones.js';
import { SummaryChips } from './SummaryChips.js';
      ...
      {activeTab === 'sessions' && (
        <div className="space-y-4">
          ...
          <SessionList
            ...
            milestones={filteredMilestones}
            filters={filters}
            {...(globalShowPublic !== undefined ? { globalShowPublic } : {})}
            showFullDate={timeScale === 'week' || timeScale === '7d' || timeScale === 'month' || timeScale === '30d'}
            {...(outsideWindowCounts !== undefined ? { outsideWindowCounts } : {})}
            onNavigateNewer={handleNavigateNewer}
            onNavigateOlder={handleNavigateOlder}
            {...(onDeleteSession !== undefined ? { onDeleteSession } : {})}
            {...(onDeleteConversation !== undefined ? { onDeleteConversation } : {})}
            {...(onDeleteMilestone !== undefined ? { onDeleteMilestone } : {})}
          />
        </div>
      )}
      ...
      {activeTab === 'insights' && (
        <div className="space-y-4 pt-2">
          ...
          <ActivityStrip
            ...
            {...(highlightDate !== undefined ? { highlightDate } : {})}
          />
