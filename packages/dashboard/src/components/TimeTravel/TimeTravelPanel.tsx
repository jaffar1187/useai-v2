...
import { SCALE_LABELS, ROLLING_SCALES, CALENDAR_SCALES, CALENDAR_SCRUB_MAP, SCRUB_CALENDAR_MAP, isCalendarScale, getTimeWindow, jumpScale, shouldSnapToLive } from './types.js';
  ...
  return (
    <div data-testid="time-travel-panel" className="flex flex-col bg-bg-surface-1 border border-border/50 rounded-2xl overflow-hidden mb-8 shadow-sm">
      ...
      <TimeScrubber
        ...
        scale={scale}
        {...(isCalendar && timeWindow !== undefined ? { window: timeWindow } : {})}
