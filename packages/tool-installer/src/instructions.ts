...
export const INSTRUCTIONS_TEXT = [
  ...
  "- While actively working, call `useai_heartbeat` every ~5 minutes. This tracks honest active time — gaps longer than 5 minutes between heartbeats are automatically counted as idle and excluded from the session duration.",
